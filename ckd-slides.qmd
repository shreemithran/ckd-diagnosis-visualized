...
<table style="font-size: 0.6em; margin: auto; border-collapse: collapse; width: 95%;">
  ...
  <tbody>
    <tr>
      ...
      <td style="padding: 8px; border: 1px solid #ccc;">0.90</td>
      <td style="padding: 8px; border: 1px solid #ccc;">Handles non-linear patterns well</td>
    </tr>
    <tr>
      ...
      <td style="padding: 8px; border: 1px solid #ccc;">0.95</td>
      <td style="padding: 8px; border: 1px solid #ccc;">Simple and effective with clear class boundaries</td>
    </tr>
    <tr style="background-color: #e8f5e9;">
      ...
      <td style="padding: 8px; border: 1px solid #ccc;"><b>0.99</b></td>
      <td style="padding: 8px; border: 1px solid #ccc;"><b>Highly interpretable and accurate</b></td>
    </tr>
  </tbody>
</table>
<br>
...
## <span style="font-size: 0.8em;">Confusion Matrix: KNN vs Decision Tree</span>
