...
##  Dataset Overview {.center}

- Dataset: Chronic Kidney Disease dataset from [Kaggle](https://www.kaggle.com/datasets/mansoordaku/ckdisease)
- 400 patient records with 26 clinical features
